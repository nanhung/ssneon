---
title: "Assessing Neonicotinoid Exposure Using Biomonitoring Data-Driven Toxicokinetic Modeling"
...
Dietary exposure assessment is a part of the regulatory process for each food-use pesticide in federal and state level [@silva_human_2010]. 
...
- High throughput and toxicokinetic model was applied to estimate the daily intake via urinary metabolites from NHANES database. 
- Compare exposure with other prediction tools.
- Hazard identification to evaluate the potential toxicity and collect the dose-response datasets from ToxCast and ICE in vitro studies.
- Bayesian dose-response model to derive AC10 as POD.
- Compare in vivo- and in-vitro derived POD
- Toxicokinetic model was used to convert the PODs into the HED with a reverse dosimetry approach.
- Combined risk of multiple neonicotinoid pesticide.


::: {.notes}
Framework for Incorporating Human Epidemiologic & Incident Data in Risk Assessments for Pesticides (US EPA, 2016b), US EPA states that quantitative biomonitoring is more advantageous than other exposure assessment methods.
:::
